-- Complete content fix migration
-- This migration ensures all pages have complete hero_title and hero_subtitle content in all three languages

-- First, let's check what content already exists
-- SELECT * FROM content ORDER BY page_key, section_key, language_code;

-- Insert or update content for all pages
...
-- Verify the content count after update
-- SELECT COUNT(*) FROM content;
-- SELECT page_key, section_key, language_code, content_text FROM content ORDER BY page_key, section_key, language_code;